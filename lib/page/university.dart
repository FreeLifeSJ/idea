...
class PageContentState extends State<PageContent>{
  ...
  Widget build(BuildContext context) {
    ...
    Column buildButtonColumn(IconData icon, String iconText , String label, Color color) {
    ...
    Widget buttonSection = new Container(
      ...
      child: new Row(
        ...
        children: [
          // 三个按钮块，两个分割线
          buildButtonColumn(Icons.offline_bolt, 'Live', '互动分享会', Colors.blue),
          SizedBox( height: 50, width: 2,
            child: Container(color: Colors.grey.shade200,),),
          buildButtonColumn(Icons.collections_bookmark, '书店', '精品电子书', Colors.green),
          SizedBox( height: 50, width: 2,
            child: Container(color: Colors.grey.shade200,),),
          buildButtonColumn(Icons.monetization_on, '付费咨询', '精品电子书', Colors.deepPurpleAccent),
        ],
      ),
    );
    // 实现 3
        ...
        child: new Column(
          ...
          children: [
            new Row(
              ...
              children: [
                SizedBox(width: 20,), // Row 内白色填充
                buildButtonColumn(Icons.offline_bolt, 'Live 猜你喜欢', ' ', Colors.blue),
              ],
            ),
            // 显示内容
            SizedBox( // 代开发填充
